...
# This block catches errors that happen before the window opens
try:
    ...
    def on_generate_click():
        ...
        try:
            for line in lines:
                ...
                parts = line.split(',')
                # Last part is distance, First part is name
...
# --- ERROR CATCHER ---
    ...
    # If the program crashes, this box appears
    root = tkinter.Tk()
    root.withdraw() # Hide the main window
    error_msg = str(traceback.format_exc())
    tkinter.messagebox.showerror("Program Error", f"The program crashed with this error:\n\n{error_msg}")
