...
try:
    ...
    def generate_multi_room_proposal(client_name, room_list, project_mode, fitout_pkgs):
        ...
        # --- IMPROVED TEXT FORMATTING HELPER ---
        def add_bold_heading_text(heading, text):
            ...
            p_body.paragraph_format.space_after = Pt(12) # Breathing room after block
            p_body.paragraph_format.line_spacing = 1.15 # Better readability
            p_body.alignment = WD_ALIGN_PARAGRAPH.JUSTIFY # Professional look
            
            for run in p_body.runs:
                run.font.name = 'Helvetica'
                run.font.size = Pt(11) # Size 11 Body
