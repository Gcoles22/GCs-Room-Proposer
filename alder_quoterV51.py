...
try:
    ...
    def load_internal_data():
        ...
        # ---------------------------------------------------------
        # 1. FIT-OUT PACKAGES (LEGACY DATA)
        # ---------------------------------------------------------
        ...
        # ---------------------------------------------------------
        # 2. DATA#3 PACKAGES (UPDATED PRICING)
        # ---------------------------------------------------------
        pricelist_data = [
            {
                "max_distance": 3.0,
                ...
                "cisco_items": [
                    ...
                    "SNTC-8X5XNBD Cisco Room Bar Pro / CON-SNT-CSBARCK9"
                ],
                "display_model": "LG 55UL3J-B - 55\" 4K UHD, 400nits",
                "display_price": 1100.00,
                "mount_model": "Wall Mount Bracket (50\"-75\") Venturi VPF-80",
                "mount_price": 56.00,
                "cables_misc": "Cables, Hardware and Consumables",
                "cables_price": 300.00,
                "service_price": 3000.00, # 800+1200+400+200+400
                "ms_annual": 1200.00 
            },
            {
                "max_distance": 4.5,
                ...
                "display_model": "LG 65UL3J-B - 65\" 4K UHD, 330nits",
            ...
            },
            {
                ...
                "cisco_items": [
                    "Cisco Room Kit EQ, Quad Cam / CS-KIT-EQ-C-K9", 
                    "Wall Mount Kit for Codec EQ / CS-CODEC-EQ-WMK",
                    "2x Cisco Ceiling Microphone White / CS-MIC-CLGPRO=",
                    "2x Wire Hanging Ceiling Kit / CS-MIC-CLGP-WHK="
                ],
                "display_model": "LG 98UM5K - 98\" 4K UHD, 330nits",
                "display_price": 7200.00,
                # Combined Bracket ($112) + Ezymount ($150)
                "mount_model": "Q-Tee Bracket (82\"-98\") + Ezymount Sliding AV Storage",
                "mount_price": 262.00, 
                "cables_misc": "Cables, Hardware and Consumables",
                "cables_price": 600.00,
                "service_price": 9200.00, # 1200+3600+800+2400+1200
                "ms_annual": 1500.00,
