...
try:
    ...
    from docx.enum.table import WD_ROW_HEIGHT_RULE, WD_ALIGN_VERTICAL # Added for height/alignment
    ...
    def get_room_configuration(distance):
        ...
        # --- TIER 2: UP TO 4.5M ---
            ...
            return {
                ...
                "cisco_items": ["Cisco Room Bar", "1x Cisco Table Microphone Pro"],
        ...
        # --- TIER 3: UP TO 5.5M ---
            ...
            return {
                ...
                "cisco_items": ["Cisco Room Bar Pro", "1x Cisco Ceiling Microphone Pro"],
    ...
    def generate_multi_room_proposal(client_name, room_list):
        ...
        # NEW: Helper to set row height and vertical center
        ...
        format_row(hdr_row, 1.0) # Slightly taller header
        hdr = hdr_row.cells
        ...
        for room in room_list:
            ...
            format_row(row_obj, 0.9) # Taller data rows for readability
            row = row_obj.cells
        ...
        for room in room_list:
            ...
            table_room.columns[0].width = Cm(3.0)  # Item
            table_room.columns[1].width = Cm(1.3)  # Qty (REQUESTED)
            table_room.columns[2].width = Cm(8.5)  # Description (REQUESTED)
            table_room.columns[3].width = Cm(2.5)  # Unit Cost
            table_room.columns[4].width = Cm(2.7)  # Total
            ...
            format_row(row_img_obj, 5.0) # Very tall row for Image
            ...
            format_row(row_sub_obj, 1.0) # Subtotal slightly taller
