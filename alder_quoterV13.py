    ...
    def get_room_configuration(distance):
        ...
        if distance <= 3.0:
            return {
                ...
                # REMOVED: Integrated Camera/Audio (Implied in Room Bar)
        ...
        # --- TIER 2: UP TO 4.5M ---
            ...
            return {
                ...
                # REMOVED: Integrated Camera (Implied). Kept ext Mic.
        ...
        # --- TIER 3: UP TO 5.5M ---
            ...
            return {
                ...
                # REMOVED: Integrated Dual Camera (Implied in Bar Pro)
        ...
        # --- TIER 5: BOARDROOM (Fixed Range to catch 7.8m) ---
            ...
            return {
                "tier_name": "Boardroom",
                # Kept Quad Cam as it is a distinct external part for EQ Kit
