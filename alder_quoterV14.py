...
try:
    ...
    def generate_multi_room_proposal(client_name, room_list):
        ...
        for room in room_list:
            ...
            # --- CHANGE 1: DISABLE AUTOFIT & SET COLUMN WIDTHS ---
            table_room.autofit = False 
            table_room.allow_autofit = False
            
            # Total printable width approx 18cm (21cm A4 - 1.5cm margins x2)
            # Requested: Qty=1.3, Desc=8.5. 
            # Remaining ~8.2cm distributed for Item, Cost, Total
            ...
            # --- CHANGE 2: NEW HEADER TEXT FORMAT ---
            ...
            for item in data['cisco_items']:
                ...
                # Just the item name, no "Supplied by Data#3" suffix
                r[2].text = item 
                r[3].text = "Excl."
                r[4].text = "Excl."
