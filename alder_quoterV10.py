...
try:
    ...
    import os
    import sys
    from PIL import Image  # Required for handling the logo
    ...
    # 1. Update Theme to Green to match logo
    ...
    lbl_instr = ctk.CTkLabel(main_frame, text="Paste Excel Data below (Name | Depth)", text_color="silver", font=("Roboto", 12))
    lbl_instr.pack(pady=(10, 2))

    txt_rooms = ctk.CTkTextbox(main_frame, width=350, height=200, corner_radius=10)
    ...
    # Status Bar
    lbl_status = ctk.CTkLabel(main_frame, text="Ready", text_color="gray", font=("Roboto", 12))
    lbl_status.pack(pady=10)
    
    # Footer
    lbl_footer = ctk.CTkLabel(app, text="v2.1 | Alder Technology Internal", text_color="#444", font=("Arial", 10))
