...
try:
    ...
    def generate_multi_room_proposal(client_name, room_list):
        ...
        doc.add_paragraph(
            "An example costing is provided below. Pricing excludes GST and is charged annually with an increase each year of 4% or CPI whichever is the greater. "
        ...
        exclusions = [
            "We exclude all power and data, plus building works.",
            "We exclude all height access equipment, and all furniture protection.",
            ...
            "A site planner shall be provided by Alder Technology."
        ]
